...
type User struct {
	...
	VerificationCodeExpiry null.Time   `boil:"verification_code_expiry" json:"verification_code_expiry,omitempty" toml:"verification_code_expiry" yaml:"verification_code_expiry,omitempty"`
...
var UserTableColumns = struct {
	...
	VerificationCodeExpiry: "users.verification_code_expiry",
}
...
var UserWhere = struct {
	...
	VerificationCodeExpiry whereHelpernull_Time
}{
	ID:                     whereHelpernull_Int64{field: "\"users\".\"id\""},
	Email:                  whereHelpernull_String{field: "\"users\".\"email\""},
	VerificationCode:       whereHelpernull_String{field: "\"users\".\"verification_code\""},
	VerificationCodeExpiry: whereHelpernull_Time{field: "\"users\".\"verification_code_expiry\""},
}
...
var (
	userAllColumns            = []string{"id", "email", "verification_code", "verification_code_expiry"}
	userColumnsWithoutDefault = []string{}
	userColumnsWithDefault    = []string{"id", "email", "verification_code", "verification_code_expiry"}
